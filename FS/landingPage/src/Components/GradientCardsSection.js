        ...
        <GradientCardsSectionStyled>
            <SectionStyled>
                ...
                <div className="gradient-cards-con">
                    <GradientCard image={person} avatar={avatar} name={'Ivan Lozano'} price={'0.067 ETH'} title={'Artificial Intelligent'} />
                    <GradientCard image={person2} avatar={avatar} name={'@Eddy Clock'} price={'0.067 ETH'} title={'Just a dummy title'}  />
